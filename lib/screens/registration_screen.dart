...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  final secondNameEController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    final firstNameField = TextFormField(
      ...
      onSaved: (value) {
        firstNameEController.text = value!;
      },
    ...
    final secondNameField = TextFormField(
      autofocus: false,
      controller: secondNameEController,
      keyboardType: TextInputType.name,
      validator: (value) {
        if (value!.isEmpty) {
          return ("finished sylabulls  cannot be empty");
        }
        return null;
      },
      onSaved: (value) {
        secondNameEController.text = value!;
      },
      textInputAction: TextInputAction.next,
      decoration: InputDecoration(
          prefixIcon: Padding(
    ...
    final confirmPasswordField = TextFormField(
      ...
      validator: (value) {
        ...
        if (confirmEController.text != passwordEController.text) {
          return ("Password don't match");
        }
        return null;
      },
      onSaved: (value) {
        confirmEController.text = value!;
      },
    ...
    final signUpButton = Material(
      ...
      child: MaterialButton(
        ...
        onPressed: () {
          signUp(emailEController.text, passwordEController.text);
        },
        child: Text(
          'Sign Up',
  ...
  postDetailsToFirestore() async {
    ...
    userModel.firstName = firstNameEController.text;
    userModel.secondName = secondNameEController.text;
